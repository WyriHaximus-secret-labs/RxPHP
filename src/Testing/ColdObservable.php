...
class ColdObservable extends Observable
{
    ...
    protected function _subscribe(ObserverInterface $observer): DisposableInterface
    {
        ...
        foreach ($this->messages as $message) {
            ...
            $schedule = function (Notification $innerNotification) use (&$disposable, $observer, $scheduler, $time, &$isDisposed): void {
        ...
        return new CallbackDisposable(function () use ($index, $scheduler, &$subscriptions, &$isDisposed): void {
            $isDisposed            = true;
